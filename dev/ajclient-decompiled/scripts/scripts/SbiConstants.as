package
{
   public class SbiConstants
   {
      ...
      public static const USERNAME_REGEX:RegExp = /(.*[a-zA-ZÀ-ÏÑ-ÖØ-Üß-ïñ-öø-üÿŸ]){3,}/i;
      ...
      public static const PASSWORD_REGEX:Array = ["[A-ZÀ-ÏÑ-ÖØ-Üß-ïñ-öø-üÿŸ]","[a-zß-ïñ-öø-üÿ]","[0-9]"];
