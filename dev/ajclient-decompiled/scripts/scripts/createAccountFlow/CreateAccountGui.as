package createAccountFlow
{
   ...
   public class CreateAccountGui
   {
      ...
      public static const MSG_ID_PASSWORD_FORMAT:int = -101;
      
      public static const MIN_PASSWORD_LENGTH:int = 12;
      ...
      public static function showNewPasswordBadMsg(param1:int = -1) : void
      {
         ...
         {
            LocalizationManager.translateId(_notifyPopup.notifyTxt,37556);
         }
         else
         {
