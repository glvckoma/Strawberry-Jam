   ...
   public class DESKey implements ISymmetricKey
   {
      ...
      protected function generateWorkingKey(param1:Boolean, param2:ByteArray, param3:uint) : Array
      {
         ...
         while(_loc6_ != 32)
         {
            ...
            _loc4_[_loc6_] = (_loc5_ & 0xFC0000) << 6 | (_loc5_ & 0x0FC0) << 10 | (_loc7_ & 0xFC0000) >>> 10 | (_loc7_ & 0x0FC0) >>> 6;
            _loc4_[_loc6_ + 1] = (_loc5_ & 0x03F000) << 12 | (_loc5_ & 0x3F) << 16 | (_loc7_ & 0x03F000) >>> 4 | _loc7_ & 0x3F;
            _loc6_ += 2;
         }
         return _loc4_;
      }
      ...
      protected function desFunc(param1:Array, param2:ByteArray, param3:uint, param4:ByteArray, param5:uint) : void
      {
         ...
         var _loc6_:* = 0;
         var _loc10_:* = 0;
         _loc7_ = uint((param2[param3 + 0] & 0xFF) << 24);
         _loc7_ = uint(_loc7_ | (param2[param3 + 1] & 0xFF) << 16);
         _loc7_ = uint(_loc7_ | (param2[param3 + 2] & 0xFF) << 8);
         _loc7_ = uint(_loc7_ | param2[param3 + 3] & 0xFF);
         _loc9_ = uint((param2[param3 + 4] & 0xFF) << 24);
         _loc9_ = uint(_loc9_ | (param2[param3 + 5] & 0xFF) << 16);
         _loc9_ = uint(_loc9_ | (param2[param3 + 6] & 0xFF) << 8);
         _loc9_ = uint(_loc9_ | param2[param3 + 7] & 0xFF);
         _loc8_ = uint((_loc7_ >>> 4 ^ _loc9_) & 0x0F0F0F0F);
         _loc9_ ^= _loc8_;
         _loc7_ ^= _loc8_ << 4;
         _loc8_ = uint((_loc7_ >>> 16 ^ _loc9_) & 0xFFFF);
         _loc9_ ^= _loc8_;
         _loc7_ ^= _loc8_ << 16;
         _loc8_ = uint((_loc9_ >>> 2 ^ _loc7_) & 0x33333333);
         _loc7_ ^= _loc8_;
         _loc9_ ^= _loc8_ << 2;
         _loc8_ = uint((_loc9_ >>> 8 ^ _loc7_) & 0xFF00FF);
         _loc7_ ^= _loc8_;
         _loc9_ ^= _loc8_ << 8;
         _loc9_ = uint((_loc9_ << 1 | _loc9_ >>> 31 & 1) & 0xFFFFFFFF);
         _loc8_ = uint((_loc7_ ^ _loc9_) & 0xAAAAAAAA);
         _loc7_ ^= _loc8_;
         _loc9_ ^= _loc8_;
         ...
         while(_loc6_ < 8)
         {
            ...
            _loc10_ = uint(SP7[_loc8_ & 0x3F]);
            _loc10_ = uint(_loc10_ | SP5[_loc8_ >>> 8 & 0x3F]);
            _loc10_ = uint(_loc10_ | SP3[_loc8_ >>> 16 & 0x3F]);
            _loc10_ = uint(_loc10_ | SP1[_loc8_ >>> 24 & 0x3F]);
            _loc8_ = uint(_loc9_ ^ param1[_loc6_ * 4 + 1]);
            _loc10_ |= SP8[_loc8_ & 0x3F];
            _loc10_ = uint(_loc10_ | SP6[_loc8_ >>> 8 & 0x3F]);
            _loc10_ = uint(_loc10_ | SP4[_loc8_ >>> 16 & 0x3F]);
            _loc10_ = uint(_loc10_ | SP2[_loc8_ >>> 24 & 0x3F]);
            _loc7_ ^= _loc10_;
         ...
         _loc8_ = uint((_loc7_ >>> 8 ^ _loc9_) & 0xFF00FF);
         _loc9_ ^= _loc8_;
         _loc7_ ^= _loc8_ << 8;
         _loc8_ = uint((_loc7_ >>> 2 ^ _loc9_) & 0x33333333);
         _loc9_ ^= _loc8_;
         _loc7_ ^= _loc8_ << 2;
         _loc8_ = uint((_loc9_ >>> 16 ^ _loc7_) & 0xFFFF);
         _loc7_ ^= _loc8_;
         _loc9_ ^= _loc8_ << 16;
         _loc8_ = uint((_loc9_ >>> 4 ^ _loc7_) & 0x0F0F0F0F);
         _loc7_ ^= _loc8_;
         _loc9_ ^= _loc8_ << 4;
         param4[param5 + 0] = _loc9_ >>> 24 & 0xFF;
         param4[param5 + 1] = _loc9_ >>> 16 & 0xFF;
         param4[param5 + 2] = _loc9_ >>> 8 & 0xFF;
         param4[param5 + 3] = _loc9_ & 0xFF;
         param4[param5 + 4] = _loc7_ >>> 24 & 0xFF;
         param4[param5 + 5] = _loc7_ >>> 16 & 0xFF;
         param4[param5 + 6] = _loc7_ >>> 8 & 0xFF;
         param4[param5 + 7] = _loc7_ & 0xFF;
      }
