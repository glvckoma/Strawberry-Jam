...
class FilesController {
  ...
  async initializeSwf() {
    try {
      ...
      const prodSwfPath = path.join(this.optionsDir, 'v5.1.1.swf')
  ...
  async getAvailableSwfFiles () {
    try {
      ...
      const order = ['v5.1.1.swf', 'v4.2.3.swf', 'non-purple-private-chat.swf', 'unmodded-ajclient.swf']
