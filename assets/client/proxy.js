            ...
            if (!hasConnected){
                try{
                    ...
                    if (parsedMessage.type == "connection"){
                        let rawUrl = parsedMessage.tcpUrl;
                        let normalizedUrl = rawUrl;
                        if (normalizedUrl.startsWith("tlssocket://") || normalizedUrl.startsWith("socket://")) {
                            normalizedUrl = normalizedUrl.replace(/^(tlssocket|socket):\/\//, "https://");
                        } else if (!normalizedUrl.includes("://")) {
                            normalizedUrl = "https://" + normalizedUrl;
                        }
                        const parsed = new URL(normalizedUrl);
                        let url = parsed.hostname;
